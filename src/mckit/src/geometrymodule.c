...
static PyGetSetDef boxobj_getsetters[] = {
  ...
  {"ez", (getter)boxobj_get_ez, NULL, "Box's EZ", NULL}, {NULL}};
...
static int boxobj_init(BoxObject* self, PyObject* args, PyObject* kwds)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "O&ddd|O&O&O&", kwlist,
          convert_to_dbl_vec, &cent, &xdim, &ydim, &zdim, convert_to_dbl_vec,
          &ex, convert_to_dbl_vec, &ey, convert_to_dbl_vec, &ez))
        return -1;
    ...
    box_init(&self->box, (double*)PyArray_DATA(cent), (double*)PyArray_DATA(ex),
      (double*)PyArray_DATA(ey), (double*)PyArray_DATA(ez), xdim, ydim, zdim);
...
static PyObject* boxobj_test_points(BoxObject* self, PyObject* points)
{
    ...
    box_test_points(
      &self->box, npts, (double*)PyArray_DATA(pts), (int*)PyArray_DATA(result));
    Py_DECREF(pts);
    return result;
}
...
static PyObject* boxobj_split(BoxObject* self, PyObject* args, PyObject* kwds)
{
    ...
    if (ratio <= 0 || ratio >= 1) {
        PyErr_SetString(
          PyExc_ValueError, "Split ratio is out of range (0, 1).");
        return NULL;
    }
...
{
    PyErr_SetString(
      PyExc_TypeError, "Can't instantiate abstract class Surface");
    return NULL;
}
...
static int cylinderobj_init(
  CylinderObject* self, PyObject* args, PyObject* kwds)
{
    PyObject *point, *axis;
    double radius;
...
static int gqobj_init(GQuadraticObject* self, PyObject* args, PyObject* kwds)
{
    ...
    gq_init(
      &self->surf, (double*)PyArray_DATA(m), (double*)PyArray_DATA(v), k, f);
...
static PyGetSetDef planeobj_getset[] = {
  ...
  {"_k", (getter)planeobj_getoffset, NULL, "Plane's offset", NULL}, {NULL}};
...
static PyGetSetDef rccobj_getset[] = {
  {"surfaces", (getter)rccobj_surfaces, NULL, "Surfaces of RCC", NULL}, {NULL}};
...
static PyGetSetDef coneobj_getset[] = {
  ...
  {"_sheet", (getter)coneobj_getsheet, NULL, "Cone's sheet", NULL}, {NULL}};
...
static PyGetSetDef torusobj_getset[] = {
  ...
  {"_axis", (getter)torusobj_getaxis, NULL, "Torus's axis", NULL}, {NULL}};
...
static PyObject* shapeobj_test_box(
  ShapeObject* self, PyObject* args, PyObject* kwds);
static PyObject* shapeobj_ultimate_test_box(
  ShapeObject* self, PyObject* args, PyObject* kwds);
static PyObject* shapeobj_test_points(ShapeObject* self, PyObject* points);
static PyObject* shapeobj_bounding_box(
  ShapeObject* self, PyObject* args, PyObject* kwds);
static PyObject* shapeobj_volume(
  ShapeObject* self, PyObject* args, PyObject* kwds);
...
static PyObject* shapeobj_getargs(ShapeObject* self, void* closure)
{
    ...
    if (self->shape.opc == COMPLEMENT || self->shape.opc == IDENTITY) {
        ...
        for (int i = 0; i < self->shape.alen; ++i) {
            pyshape =
              parent_pyobject(ShapeObject, shape, self->shape.args.shapes[i]);
...
static int shapeobj_init(ShapeObject* self, PyObject* args, PyObject* kwds)
{
    ...
    if (opc == IDENTITY || opc == COMPLEMENT) {
        ...
        Py_INCREF(surf);
        status =
          shape_init(&self->shape, opc, 1, &((SurfaceObject*)surf)->surf);
        ...
        if (alen <= 1) {
            PyErr_SetString(
              PyExc_ValueError, "More than one shape object is expected");
            return -1;
        }
        PyObject* item;
  ...
  ShapeObject* self, PyObject* args, PyObject* kwds)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(
          args, kwds, "|Odb", kwlist, &box, &min_vol, &collect))
        return NULL;
    ...
    shape_reset_cache(&self->shape);
    int result = shape_ultimate_test_box(
      &self->shape, &((BoxObject*)box)->box, min_vol, collect);
    return Py_BuildValue("i", result);
}
  ...
  ShapeObject* self, PyObject* args, PyObject* kwds)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(
          args, kwds, "|dO", kwlist, &tol, &start_box))
        return NULL;
...
static PyModuleDef geometry_module = {PyModuleDef_HEAD_INIT, "geometry",
  "Geometry native objects.", -1, NULL, NULL, NULL, NULL, NULL};
