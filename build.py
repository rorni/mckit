...
from build_nlopt import SYSTEM_WINDOWS, build_nlopt
...
def build(setup_kwargs):
    ...
    # Save setup.py generated by pip for inspection and build.py debugging
    setup_file = Path("setup.py")
    if (
        setup_file.exists()
    ):  # it may not exist, if we run build.py from other script for debugging
        shutil.copy(str(setup_file), "setup-generated.py")
        print("Saved setup.py as setup-generated.py")
