...
data = {
    ...
    'Cone': [
        ([0, 0, 0], [1, 0, 0], 0.5, 0), ([0, 0, 0], [1, 0, 0], 0.5, -1, 0), ([0, 0, 0], [1, 0, 0], 0.5, +1, 0),
        ([0, 1.4, 0], [1, 0, 0], 0.5, 0), ([0, 1.4, 0], [1, 0, 0], 0.5, -1, 0), ([0, 1.4, 0], [1, 0, 0], 0.5, +1, 0),
        ([0, 1.6, 0], [1, 0, 0], 0.5, +1), ([0, 1.6, 0], [1, 0, 0], 0.5, -1, +1), ([0, 1.6, 0], [1, 0, 0], 0.5, +1, +1),
        ([0, -1.4, 0], [1, 0, 0], 0.5, 0), ([0, -1.4, 0], [1, 0, 0], 0.5, -1, 0), ([0, -1.4, 0], [1, 0, 0], 0.5, +1, 0),
        ([0, -1.6, 0], [1, 0, 0], 0.5, +1), ([0, -1.6, 0], [1, 0, 0], 0.5, -1, +1), ([0, -1.6, 0], [1, 0, 0], 0.5, +1, +1),
        ([-1, 1.9, 0], [1, 0, 0], 0.5, 0), ([-1, 1.9, 0], [1, 0, 0], 0.5, -1, +1), ([-1, 1.9, 0], [1, 0, 0], 0.5, +1, 0),
        ([1, 2.1, 0], [1, 0, 0], 0.5, +1), ([1, 2.1, 0], [1, 0, 0], 0.5, -1, +1), ([1, 2.1, 0], [1, 0, 0], 0.5, +1, +1),
        ([3.9, 0, 0], [1, 0, 0], 0.5, -1), ([3.9, 0, 0], [1, 0, 0], 0.5, -1, -1), ([3.9, 0, 0], [1, 0, 0], 0.5, +1, +1),
        ([-3.9, 0, 0], [1, 0, 0], 0.5, -1), ([-3.9, 0, 0], [1, 0, 0], 0.5, -1, +1), ([-3.9, 0, 0], [1, 0, 0], 0.5, +1, -1),
        ([0, 0, -3.9], [0, 0, 1], 0.5, -1), ([0, 0, -3.9], [0, 0, 1], 0.5, -1, +1), ([0, 0, -3.9], [0, 0, 1], 0.5, +1, -1),
        ([0, 0, 3.9], [0, 0, 1], 0.5, -1), ([0, 0, 3.9], [0, 0, 1], 0.5, -1, -1), ([0, 0, 3.9], [0, 0, 1], 0.5, +1, +1),
        ([0, -3.9, 0], [0, 1, 0], 0.5, -1), ([0, -3.9, 0], [0, 1, 0], 0.5, -1, +1), ([0, -3.9, 0], [0, 1, 0], 0.5, +1, -1),
        ([3.8, 0, 0], [1, 0, 0], 0.5, 0), ([3.8, 0, 0], [1, 0, 0], 0.5, -1, 0), ([3.8, 0, 0], [1, 0, 0], 0.5, +1, +1),
        ([-3.8, 0, 0], [1, 0, 0], 0.5, 0), ([-3.8, 0, 0], [1, 0, 0], 0.5, -1, +1), ([-3.8, 0, 0], [1, 0, 0], 0.5, +1, 0),
        ([0, 0, -3.8], [0, 0, 1], 0.5, 0), ([0, 0, -3.8], [0, 0, 1], 0.5, -1, +1), ([0, 0, -3.8], [0, 0, 1], 0.5, +1, 0),
        ([0, 0, 3.8], [0, 0, 1], 0.5, 0), ([0, 0, 3.8], [0, 0, 1], 0.5, -1, 0), ([0, 0, 3.8], [0, 0, 1], 0.5, +1, +1),
        ([0, -3.8, 0], [0, 1, 0], 0.5, 0), ([0, -3.8, 0], [0, 1, 0], 0.5, -1, +1), ([0, -3.8, 0], [0, 1, 0], 0.5, +1, 0)
    ],
    'Torus': [
