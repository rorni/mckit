...
data = {
    ...
    'Cone': [
        ('KX', [4.6, 0.33], {'_apex': [4.6, 0, 0], '_axis': [1, 0, 0], '_t2': 0.33, '_sheet': 0}),
        ('KY', [4.7, 0.33], {'_apex': [0, 4.7, 0], '_axis': [0, 1, 0], '_t2': 0.33, '_sheet': 0}),
        ('KZ', [-4.8, 0.33], {'_apex': [0, 0, -4.8], '_axis': [0, 0, 1], '_t2': 0.33, '_sheet': 0}),
        ('K/X', [4.9, -5.0, 5.1, 0.33], {'_apex': [4.9, -5.0, 5.1], '_axis': [1, 0, 0], '_t2': 0.33, '_sheet': 0}),
        ('K/Y', [-5.0, -5.1, 5.2, 0.33], {'_apex': [-5.0, -5.1, 5.2], '_axis': [0, 1, 0], '_t2': 0.33, '_sheet': 0}),
        ('K/Z', [5.3, 5.4, 5.5, 0.33], {'_apex': [5.3, 5.4, 5.5], '_axis': [0, 0, 1], '_t2': 0.33, '_sheet': 0}),
        ('KX', [4.6, 0.33, +1],
        ...
        ('K/X', [4.9, -5.0, 5.1, 0.33, +1],
         {'_apex': [4.9, -5.0, 5.1], '_axis': [1, 0, 0], '_t2': 0.33,
          '_sheet': +1}),
        ('K/Y', [-5.0, -5.1, 5.2, 0.33, +1],
         {'_apex': [-5.0, -5.1, 5.2], '_axis': [0, 1, 0], '_t2': 0.33,
          '_sheet': +1}),
        ('K/Z', [5.3, 5.4, 5.5, 0.33, +1],
         {'_apex': [5.3, 5.4, 5.5], '_axis': [0, 0, 1], '_t2': 0.33,
          '_sheet': +1}),
        ('KX', [4.6, 0.33, -1],
         {'_apex': [4.6, 0, 0], '_axis': [1, 0, 0], '_t2': 0.33, '_sheet': -1}),
        ('KY', [4.7, 0.33, -1],
