...
get_contained_cells_ans = {
    'model1': {
        (0, True): {
            0: {1, 2, 11, 12, 13, 14, 15}, 1: {3, 4}, 2: {5, 6}, 3: {7, 8}, 4: {9, 10}
        },
        (0, False): {
...
transformation_print_ans = {
    'model1': {
        1: ['TR1', '5', '-3', '4'],
        2: ['*TR2', '1', '1', '1', '30', '60', '90', '120', '30', '90', '90',
            '90', '0', '-1'],
        3: ['*TR3', '1', '2', '3', '30', '60', '90', '120', '30', '90', '90',
            '90', '0'],
        4: ['*TR4', '-1', '-2', '-3', '30', '60', '90', '120', '30', '90', '90',
            '90', '0']
    }
}
...
cell_print_ans = {
    'model1': {
        ...
        8: ['8', '4', '-4', '1', '5', '-7', 'U=3'],
        9: ['9', '2', '-2', '2', '-5', '7', 'U=4'],
        10: ['10', '0', '5', '-6', 'U=4', '*FILL=1', '(', '7', '3', '1', '30',
             '60', '90', '120', '30', '90', '90', '90', '0', ')'],
        11: ['11', '0', '6', '7', 'FILL=2'],
        12: ['12', '0', '5', '7', 'FILL=3'],
        13: ['13', '0', '(', '1', ':', '-2', ')',  '(', '3', ':', '-4', ')',
             'IMP:N=1', 'IMP:P=1', '*TRCL=', '(', '7', '3', '1', '30', '60', '90', '120', '30', '90', '90', '90', '0', ')'],
        14: ['14', '0', '#(', '1', '-2', ')', ':', '#(', '3', ':', '-4', ')',
             'IMP:N=1', 'IMP:P=1'],
