...
@pytest.mark.parametrize('args', [
    ...
    {'rotation': [30.058, 59.942, 90, 120, 30, 90, 90, 90, 0],
     'indegrees': True},
    {'rotation': [29.942, 60.058, 90, 120, 30, 90, 90, 90, 0],
     'indegrees': True},
    {'rotation': [30, 60, 90, 120.058, 30.058, 90, 90, 90, 0],
     'indegrees': True},
    {'rotation': [30, 60, 90, 119.942, 29.942, 90, 90, 90, 0],
     'indegrees': True},
...
@pytest.mark.parametrize('args', [
    {'rotation': [30.057, 59.943, 90, 120, 30, 90, 90, 90, 0],
     'indegrees': True},
    {'rotation': [29.943, 60.057, 90, 120, 30, 90, 90, 90, 0],
     'indegrees': True},
    {'rotation': [30, 60, 90, 120.057, 30.057, 90, 90, 90, 0],
     'indegrees': True},
    {'rotation': [30, 60, 90, 119.943, 29.943, 90, 90, 90, 0],
     'indegrees': True},
    {'rotation': [30, 60, 90, 120, 30, 90, 90.057, 90, 0.057],
     'indegrees': True},
...
def transforms():
    return Transformation(translation=[1, 2, -3], indegrees=True,
...
@pytest.mark.parametrize('points, expected', [
    ...
    (np.array([[1, 0, 0], [2, 0, 0], [0, 1, 0], [0, 2, 0], [0, 0, 1]]),
     np.array([[np.sqrt(3) / 2 + 1, 2.5, -3], [np.sqrt(3) + 1, 3, -3],
               [0.5, np.sqrt(3) / 2 + 2, -3], [0, np.sqrt(3) + 2, -3],
               [1, 2, -2]]))
])
...
@pytest.mark.parametrize('norm, point', [
...
def test_plane_transformation(transforms, norm, point):
    ...
    assert k == pytest.approx(k_ref, rel=1.e-10)


@pytest.mark.parametrize('point, radius', [
    (np.array([3, -4, 7]), 4)
])
